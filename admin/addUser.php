...
<head>
    ...
    <link rel="stylesheet" href="../Stylings/addNewUser.css">
...
<?php
    ...
    <div class="form">
        ...
        <form action="addUserScript.php" method="POST" enctype="multipart/form-data">
            ...
            <div>
                <label for="doc">Identity Proof</label><br>
                <input type="file" name="doc">
                <p class="hint">*Only PDF, Docx and Doc files are allowed!</p>
            </div>
            ...
            <input class="userid" type="text" name="admin_id" value="<?php echo $row['id'];?>">
